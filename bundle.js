...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  { store: store },
	  _react2.default.createElement(_reactRouter.Router, { routes: _router2.default, history: _reactRouter.browserHistory })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseGetTag = __webpack_require__(252),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(253),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _app3 = __webpack_require__(264);

	var _app4 = _interopRequireDefault(_app3);

	var _app5 = __webpack_require__(299);

	var _app6 = _interopRequireDefault(_app5);

	var _requireAuth = __webpack_require__(302);
	...
	exports.default = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: 'login', component: _app4.default }),
	  _react2.default.createElement(
	    _reactRouter.Route,
	    { path: 'dashboard', component: (0, _requireAuth2.default)(_app6.default) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _section = __webpack_require__(296);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _logo = __webpack_require__(295);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (0, _reactRedux.connect)(null, _actions2.default)(LoginForm);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var URL = 'http://localhost:3000'; //node server
	...
	function loginUser(_ref) {
	  ...
	  return function (dispatch) {
	    _axios2.default.post(URL + '/login', { email: email, password: password }).then(function (res) {
	      dispatch({ type: _types.AUTH_USER }); //update state for authed user
	      localStorage.setItem('token', res.data.token); //store token to localStorage
	      _reactRouter.browserHistory.push('/dashboard');
	    }).catch(function (err) {
	      return dispatch(handleAuthError(err));
	    });
	  };
	}
	function logoutUser() {
	  return function (dispatch) {
	    ...
	    dispatch({ type: _types.UNAUTH_USER }); //update state for unauthed user
	    _reactRouter.browserHistory.push('/login');
	  };
	}
	function signUpUser(newUser) {
	  return function (dispatch) {
	    _axios2.default.post(URL + '/signup', newUser).then(function (res) {
	      dispatch({ type: _types.AUTH_USER }); //auth user in auth_reducer
...
/***/ function(module, exports) {
	...
	var GET_INITIAL_USER_DATA = exports.GET_INITIAL_USER_DATA = 'GET_INITIAL_USER_DATA';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return _react2.default.createElement("img", { src: "/src/imgs/facebook-logo-preview.png", alt: "fb-logo" });
	};
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  function SignUp(props) {
	    ...
	    _this.onSignUp = function (e) {
	      ...
	      var _this$refs = _this.refs,
	          firstName = _this$refs.firstName,
	          lastName = _this$refs.lastName,
	          email = _this$refs.email,
	          confirmEmail = _this$refs.confirmEmail,
	          password = _this$refs.password,
	          month = _this$refs.month,
	          day = _this$refs.day,
	          year = _this$refs.year;
	      ...
	      _this.setState(newUser);
	      _this.props.signUpUser(newUser);
	    };

	    _this.onChangeSex = function (e) {
	      _this.setState({ sex: e.target.value });
	    };
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { ref: 'firstName', type: 'text', placeholder: 'First name', className: 'form-control' }),
	            _react2.default.createElement('input', { ref: 'lastName', type: 'text', placeholder: 'Last name', className: 'form-control' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group' },
	            _react2.default.createElement('input', { ref: 'email', type: 'text', placeholder: 'Mobile number or email', className: 'form-control' }),
	            _react2.default.createElement('input', { ref: 'confirmEmail', type: 'text', placeholder: 'Re-enter email', className: 'form-control' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group' },
	            _react2.default.createElement('input', { ref: 'password', type: 'password', placeholder: 'New password' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group' },
	...
	exports.default = (0, _reactRedux.connect)(null, _actions2.default)(SignUp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _topnav = __webpack_require__(301);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopNav = function (_Component) {
	  ...
	  function TopNav() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TopNav.__proto__ || Object.getPrototypeOf(TopNav)).call.apply(_ref, [this].concat(args))), _this), _this.onLogoutUser = function () {
	...
	exports.default = (0, _reactRedux.connect)(null, _actions2.default)(TopNav);
	  ...
	  var Authentication = function (_Component) {
	    ...
	    _createClass(Authentication, [{
	      ...
	      value: function componentWillMount() {
	        !this.props.authenticated ? _reactRouter.browserHistory.push('/login') : null;
	      }
	    }, {
	      key: 'componentWillUpdate',
	      value: function componentWillUpdate(props) {
	        //new props are passed to this method
	        !props.authenticated ? _reactRouter.browserHistory.push('/login') : null;
	      }
	      //authed
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _auth_reducer = __webpack_require__(304);

	var _auth_reducer2 = _interopRequireDefault(_auth_reducer);

	var _user_reducer = __webpack_require__(305);
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    case _types.AUTH_USER:
	      return _extends({}, state, { authenticated: true, error: null });
	    case _types.UNAUTH_USER:
	      return _extends({}, state, { authenticated: false, error: null });
	    case _types.AUTH_ERROR:
	      return _extends({}, state, { authenticated: false, error: action.errMessage });
	  }
	  return state;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    case _types.GET_INITIAL_USER_DATA:
